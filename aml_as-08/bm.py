...
from utils_bm import data_statistics, model_statistics, log_likelihood, random_small_dataset, load_data, plot_loglik, plot_schneidman
# import utils_bm
...
@partial(jax.jit, static_argnums=(2, 3, 4))
def mean_field(df, key, eta:int = 0.01, max_iter:int = 100_000, eps:float = 1e-13):
  """
